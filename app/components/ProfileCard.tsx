...
export default function ProfileCard() {
  return (
    <div className="hidden md:flex flex-col w-[320px] lg:w-[360px] xl:w-[400px] h-screen p-4 shrink-0">
      <div className="relative flex flex-col h-full rounded-2xl overflow-hidden bg-bg-card border border-border-card profile-card-glow animate-glow-pulse">
        {/* Profile Photo */}
        <div className="relative flex-1 min-h-0">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            ...
            <p className="text-text-secondary text-sm mt-1 flex items-center gap-0.5">
              Full Stack Developer
              <span className="animate-blink text-neon font-bold ml-0.5">
                _
              </span>
            </p>
