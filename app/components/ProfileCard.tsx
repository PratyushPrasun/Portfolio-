...
export default function ProfileCard() {
  return (
    <div className="hidden md:flex flex-col xl:h-[580px] xl:w-[380px] shrink-0 p-4 pt-12 pb-10">
      <div className="relative flex flex-col h-full rounded-2xl overflow-hidden bg-bg-card border border-border-card">
        {/* Profile Photo */}
        <div className="relative flex-1 min-h-0">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col items-center text-center">
            <h1 className="glitch-text text-3xl lg:text-4xl font-semibold text-white tracking-tight" data-text="Pratyush">
              Pratyush
            </h1>
            <p className="text-neon text-lg mt-1 flex items-center gap-0.5">
              Full Stack Developer
              <span className="animate-blink  font-bold ml-0.5">
                _
              </span>
            </p>
